...
registerStrings({
  ...
  'hr.training.title_required': { ar: 'اسم الدورة مطلوب', en: 'Training title is required' },
  'hr.training.category': { ar: 'المجال', en: 'Category' },
  'hr.training.provider': { ar: 'الجهة المدرِّبة', en: 'Provider' },
  'hr.training.hours': { ar: 'الساعات', en: 'Hours' },
  'hr.training.status': { ar: 'الحالة', en: 'Status' },
  'hr.training.rating': { ar: 'التقييم', en: 'Rating' },
  'hr.training.notes': { ar: 'ملاحظات', en: 'Notes' },
  'hr.training.add': { ar: 'إضافة تدريب', en: 'Add training' },
  'hr.training.edit': { ar: 'تعديل التدريب', en: 'Edit training' },
  'hr.training.empty': { ar: 'لا توجد دورات تدريبية بعد', en: 'No trainings yet' },
  'hr.training.confirm_delete': { ar: 'حذف هذا التدريب؟', en: 'Delete this training?' },
  'hr.training.total': { ar: 'إجمالي الدورات', en: 'Total trainings' },
  'hr.training.completed': { ar: 'المكتملة', en: 'Completed' },
  'hr.training.total_hours': { ar: 'إجمالي الساعات', en: 'Total hours' },
  'hr.training.avg_rating': { ar: 'متوسط التقييم', en: 'Average rating' },
  'hr.training.cat.TECHNICAL': { ar: 'تقني', en: 'Technical' },
  'hr.training.cat.SAFETY': { ar: 'السلامة', en: 'Safety' },
  'hr.training.cat.SOFT_SKILLS': { ar: 'مهارات شخصية', en: 'Soft skills' },
  'hr.training.cat.COMPLIANCE': { ar: 'الامتثال', en: 'Compliance' },
  'hr.training.cat.LEADERSHIP': { ar: 'القيادة', en: 'Leadership' },
  'hr.training.cat.OTHER': { ar: 'أخرى', en: 'Other' },
  'hr.training.st.PLANNED': { ar: 'مخطط', en: 'Planned' },
  'hr.training.st.IN_PROGRESS': { ar: 'قيد التنفيذ', en: 'In progress' },
  'hr.training.st.COMPLETED': { ar: 'مكتمل', en: 'Completed' },

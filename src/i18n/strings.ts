...
registerStrings({
  ...
  'header.photo.add': { ar: 'إضافة صورة', en: 'Add photo' },
  'header.photo.change': { ar: 'تغيير الصورة', en: 'Change photo' },
  'header.photo.saved': { ar: 'تم حفظ الصورة', en: 'Photo saved' },
  ...
  'header.notif.title': { ar: 'التنبيهات', en: 'Notifications' },
  'header.notif.empty': { ar: 'لا توجد تنبيهات', en: 'No alerts' },
  // Per-user notification center
  'notif.leave_approved': { ar: 'تمت الموافقة على إجازتك', en: 'Your leave was approved' },
  'notif.leave_rejected': { ar: 'تم رفض طلب إجازتك', en: 'Your leave was rejected' },
  'notif.summoned': { ar: 'تم استدعاؤك لمقابلة', en: 'You have been summoned for a talk' },
  'notif.recalled': { ar: 'تم استدعاؤك من الإجازة', en: 'You have been recalled from leave' },
  'notif.question': { ar: 'سؤال من المدير حول إجازتك', en: 'A question from your manager about your leave' },
  'notif.training_assigned': { ar: 'تم تعيين تدريب لك', en: 'A training was assigned to you' },
  'notif.pending_leaves': { ar: '{n} طلب إجازة بانتظار موافقتك', en: '{n} leave request(s) awaiting your approval' },
  'notif.pending_leaves_sub': { ar: 'راجع طلبات الإجازات في الموارد البشرية', en: 'Review leave requests in HR' },
  'notif.veh_expired': { ar: 'وثيقة المركبة منتهية', en: 'Vehicle document expired' },
  'notif.veh_soon': { ar: 'وثيقة المركبة قرب الانتهاء', en: 'Vehicle document expiring soon' },
  ...
  'header.notif.days_left': { ar: 'يوم متبقٍ', en: 'days left' },

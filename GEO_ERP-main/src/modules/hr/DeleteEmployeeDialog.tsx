    ...
    >
      <div className="space-y-4">
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50/60 p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-bold text-slate-700">{t('hr.delete.archive_option')}</p>
                <p className="mt-0.5 text-xs text-slate-500">{t('hr.delete.archive_hint')}</p>
              </div>
            </div>
        ...
        <div className="rounded-xl border border-red-200 bg-red-50/50 p-4">
          <div className="flex items-start gap-3">
            <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-red-100 text-danger">
              <AlertTriangle className="h-5 w-5" />
            </span>
            <div className="min-w-0 flex-1">
              <p className="text-sm font-bold text-danger">{t('hr.delete.permanent_option')}</p>
              <p className="mt-0.5 text-xs text-slate-500">{t('hr.delete.permanent_hint')}</p>
            </div>
          </div>
